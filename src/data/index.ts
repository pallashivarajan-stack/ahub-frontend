...
export const portfolio = [
  ...
  },
  {
    ...
    industry: "EdTech",
    category: "EDTECH",
    desc: "Empowering students through community and skill-building platforms.",
    achievements: ["Skill Building", "Community Led", "Student Focus"],
    funding: "Pre-Seed · $300K",
    logo: asset("/src/assets/portolfio companies/edu_moon-removebg-preview.png"),
    founderImage: asset("/src/assets/portfolio/edumoon_founder.jpg"),
    website: "https://edumoon.in",
  },
  {
    founder: "Tarun Jami",
    founderTitle: "Founder & CEO",
    ...
    category: "CLIMATE",
    desc: "Creating carbon-negative building materials from agricultural residue.",
    achievements: ["Carbon Negative", "Agrocrete", "Sustainable"],
    funding: "Seed · $500K",
    logo: asset("/src/assets/portolfio companies/green_jams-removebg-preview.png"),
    founderImage: asset("/src/assets/portfolio/greenjams_founder.jpg"),
    website: "https://greenjams.org",
  },
  {
    founder: "Priya",
    ...
    industry: "EdTech",
    category: "EDTECH",
    desc: "Fostering a habit of reading and continuous learning among youth.",
    achievements: ["Reading Clubs", "Youth Focus", "Continuous Learning"],
    funding: "Bootstrapped",
    logo: asset("/src/assets/portolfio companies/pick_a_book-removebg-preview.png"),
    founderImage: asset("/src/assets/portfolio/pick_a_book_founder.png"),
    website: "https://pickabook.in",
  },
  {
    founder: "Rajesh",
    founderTitle: "Founder & CEO",
    ...
    industry: "Deep Tech",
    category: "DEEP TECH",
    desc: "Advanced technology venture developing scalable software for data-intensive applications.",
    achievements: ["Scalable Software", "Data Intensive", "Deep Tech"],
    funding: "Seed · $1M",
    logo: asset("/src/assets/portolfio companies/tessrac-removebg-preview.png"),
    founderImage: asset("/src/assets/portfolio/tierra_automations_founder.jpg"),
    website: "https://tessrac.com",
  },
];
