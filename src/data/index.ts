...
export const portfolio = [
  ...
  },
  {
    ...
    category: "AI TECH",
    desc: "AI-powered automation and intelligent bot solutions for businesses.",
    achievements: ["AI Automation", "Bot Solutions", "Smart Workflows"],
    funding: "Seed · $500K",
  ...
  },
  {
    ...
    category: "DRONE TECH",
    desc: "Drone consulting and solutions for agriculture, surveying, and defence applications.",
    achievements: ["Drone Consulting", "Agriculture Drones", "Survey Solutions"],
    funding: "Seed · $400K",
  ...
  },
  {
    ...
    industry: "EdTech",
    category: "EDTECH",
    desc: "Accelerated coding bootcamp empowering students with industry-ready tech skills.",
    achievements: ["Coding Bootcamps", "Tech Training", "Career Placement"],
    funding: "Seed · $1M",
