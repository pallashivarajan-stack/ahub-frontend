...
export type PressPageMeta = {
  heading: string;
  subheading: string;
};

export const defaultPressPageMeta: PressPageMeta = {
  heading: "Press",
  subheading: "Latest news, press releases & media coverage from our innovation ecosystem.",
};
