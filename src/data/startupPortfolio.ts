...
export const startupDirectory: StartupItem[] = [
  ...
  { id: "pick-a-book", name: "Pick A Book", logo: pickABookLogo, category: "EdTech", industry: "Education", founded: 2022, fundingStage: "Pre-Seed", description: "Reading habit platform fostering continuous learning and youth engagement through curated book clubs.", website: "https://pickabook.lk/", popularity: 76, addedOrder: 4 },
  ...
  { id: "bizpro", name: "BizPro", logo: bizproLogo, category: "SaaS", industry: "Enterprise", founded: 2023, fundingStage: "Pre-Seed", description: "Business operations suite helping SMBs manage workflows, billing, and customer relationships.", website: "https://bizproindia.com/", popularity: 65, addedOrder: 11 },
  ...
  { id: "furpsq", name: "Furpsq", logo: furpsqLogo, category: "Consumer", industry: "Lifestyle", founded: 2023, fundingStage: "Pre-Seed", description: "Consumer-focused brand building innovative lifestyle products for modern urban audiences.", website: "https://furpsq.com/", popularity: 55, addedOrder: 17 },
  ...
  { id: "nr-techcreatz", name: "NR Techcreatz", logo: nrTechcreatzLogo, category: "Deep Tech", industry: "Technology", founded: 2023, fundingStage: "Pre-Seed", description: "Creative technology studio building digital products at the intersection of design and engineering.", website: "https://www.nrtechcreatz.com/", popularity: 56, addedOrder: 27 },
  ...
  { id: "spot-times", name: "Spot Times", logo: spotTimesLogo, category: "Media", industry: "Publishing", founded: 2023, fundingStage: "Pre-Seed", description: "Local news and events platform surfacing community stories and hyperlocal engagement.", website: "https://www.spotmies.com/", popularity: 51, addedOrder: 33 },
...
export type SortOption = "default" | "newest" | "oldest" | "popular" | "recent";
...
export function filterStartups(
  ...
  result = [...result].sort((a, b) => {
    switch (sort) {
      ...
      case "default":
      default:
        // Use addedOrder (ascending) which matches admin display_order
