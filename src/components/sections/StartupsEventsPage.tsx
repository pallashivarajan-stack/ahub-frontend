...
import startupHeroImg from "@/assets/startup-event-hero.png";
...
const EVENTS_DATA: RedesignedEvent[] = [
  {
    id: "google-ux-2025",
...
export function StartupsEventsPage() {
  ...
  const filteredEvents = useMemo(() => {
    if (selectedFilter === "All Events") return EVENTS_DATA;
